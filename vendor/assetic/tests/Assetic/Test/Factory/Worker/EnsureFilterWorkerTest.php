...
class EnsureFilterWorkerTest extends \PHPUnit_Framework_TestCase {
	public function testMatch() {
		...
		$asset->expects($this->once())->method('getTargetPath')->will($this->returnValue('css/main.css'));
	...
	public function testNonMatch() {
		...
		$asset->expects($this->once())->method('getTargetPath')->will($this->returnValue('js/all.js'));
