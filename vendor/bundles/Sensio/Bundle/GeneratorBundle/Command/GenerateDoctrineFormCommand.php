...
class GenerateDoctrineFormCommand extends GenerateDoctrineCommand {
	...
	protected function configure() {
		$this->setDefinition(array(new InputArgument('entity', InputArgument::REQUIRED, 'The entity class name to initialize (shortcut notation)'),))->setDescription('Generates a form type class based on a Doctrine entity')
				->setHelp(<<<EOT
...
EOT
				)->setName('doctrine:generate:form')->setAliases(array('generate:doctrine:form'));
	}
