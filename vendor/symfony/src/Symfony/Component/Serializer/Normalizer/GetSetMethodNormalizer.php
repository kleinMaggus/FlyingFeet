		...
		if ($constructor) {
			...
			foreach ($constructorParameters as $constructorParameter) {
				...
				if (isset($data[$paramName])) {
					...
					throw new RuntimeException('Cannot create an instance of ' . $class . ' from serialized data because its constructor requires ' . 'parameter "' . $constructorParameter->getName() . '" to be present.');
				}
			}
