		...
		foreach (array_keys($content) as $namespace) {
			...
			if (!$this->container->hasExtension($namespace)) {
				...
				throw new \InvalidArgumentException(
						sprintf('There is no extension able to load the configuration for "%s" (in %s). Looked for namespace "%s", found %s', $namespace, $file, $namespace, $extensionNamespaces ? sprintf('"%s"', implode('", "', $extensionNamespaces)) : 'none'));
			}
		}
