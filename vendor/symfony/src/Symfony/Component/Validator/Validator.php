...
class Validator implements ValidatorInterface {
	...
	public function __construct(ClassMetadataFactoryInterface $metadataFactory, ConstraintValidatorFactoryInterface $validatorFactory, array $validatorInitializers = array()) {
