...
class ClearQueryCacheDoctrineCommand extends QueryCommand {
	protected function configure() {
		...
		$this->setName('doctrine:cache:clear-query')->setDescription('Clear all query cache for a entity manager')->addOption('em', null, InputOption::VALUE_OPTIONAL, 'The entity manager to use for this command')
				->setHelp(
						<<<EOT
