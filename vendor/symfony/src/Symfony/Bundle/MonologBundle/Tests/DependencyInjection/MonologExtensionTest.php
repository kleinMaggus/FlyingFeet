	...
	public function testLoadWithSeveralHandlers() {
		...
		$loader
				->load(
						array(
								array(
										'handlers' => array('custom' => array('type' => 'stream', 'path' => '/tmp/symfony.log', 'bubble' => false, 'level' => 'ERROR'), 'main' => array('type' => 'fingers_crossed', 'action_level' => 'ERROR', 'handler' => 'nested'),
												'nested' => array('type' => 'stream')))), $container);
		$this->assertTrue($container->hasDefinition('monolog.logger'));
		$this->assertTrue($container->hasDefinition('monolog.handler.custom'));
		$this->assertTrue($container->hasDefinition('monolog.handler.main'));
		...
		$loader
				->load(
						array(
								array(
										'handlers' => array('custom' => array('type' => 'stream', 'path' => '/tmp/symfony.log', 'bubble' => false, 'level' => 'ERROR'), 'main' => array('type' => 'fingers_crossed', 'action_level' => 'ERROR', 'handler' => 'nested'),
												'nested' => array('type' => 'stream'))), array('handlers' => array('custom' => array('type' => 'stream', 'path' => '/tmp/symfony.log', 'bubble' => true, 'level' => 'WARNING'),))), $container);
		$this->assertTrue($container->hasDefinition('monolog.logger'));
		$this->assertTrue($container->hasDefinition('monolog.handler.custom'));
		$this->assertTrue($container->hasDefinition('monolog.handler.main'));
		$this->assertTrue($container->hasDefinition('monolog.handler.nested'));
	...
	public function testLoadWithNewAtEnd() {
		...
		$loader
				->load(
						array(
								array(
										'handlers' => array('custom' => array('type' => 'stream', 'path' => '/tmp/symfony.log', 'bubble' => true, 'level' => 'ERROR'), 'main' => array('type' => 'fingers_crossed', 'action_level' => 'ERROR', 'handler' => 'nested'),
												'nested' => array('type' => 'stream'))),
								array(
										'handlers' => array('custom' => array('type' => 'stream', 'path' => '/tmp/symfony.log', 'bubble' => false, 'level' => 'WARNING'), 'new' => array('type' => 'stream', 'path' => '/tmp/monolog.log', 'bubble' => true, 'level' => 'ERROR'),))), $container);
		$this->assertTrue($container->hasDefinition('monolog.logger'));
		$this->assertTrue($container->hasDefinition('monolog.handler.custom'));
		$this->assertTrue($container->hasDefinition('monolog.handler.main'));
		$this->assertTrue($container->hasDefinition('monolog.handler.nested'));
	...
	public function testLoadWithNewAndPriority() {
		...
		$loader
				->load(
						array(
								array(
										'handlers' => array('custom' => array('type' => 'stream', 'path' => '/tmp/symfony.log', 'bubble' => true, 'level' => 'ERROR'), 'main' => array('type' => 'buffer', 'level' => 'INFO', 'handler' => 'nested'), 'nested' => array('type' => 'stream'))),
								array(
										'handlers' => array('custom' => array('type' => 'stream', 'path' => '/tmp/symfony.log', 'bubble' => true, 'level' => 'WARNING'), 'first' => array('type' => 'rotating_file', 'path' => '/tmp/monolog.log', 'bubble' => true, 'level' => 'ERROR', 'priority' => 3),
												'last' => array('type' => 'stream', 'path' => '/tmp/last.log', 'bubble' => true, 'level' => 'ERROR', 'priority' => -3),))), $container);
		$this->assertTrue($container->hasDefinition('monolog.logger'));
		$this->assertTrue($container->hasDefinition('monolog.handler.custom'));
		$this->assertTrue($container->hasDefinition('monolog.handler.main'));
		$this->assertTrue($container->hasDefinition('monolog.handler.nested'));
