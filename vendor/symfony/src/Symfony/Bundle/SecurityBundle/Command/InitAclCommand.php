...
class InitAclCommand extends ContainerAwareCommand {
	...
	protected function configure() {
		$this->setName('init:acl')->setDescription('Mounts ACL tables in the database')
				->setHelp(
						<<<EOT
...
EOT
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$tables = array('class_table_name' => $this->getContainer()->getParameter('security.acl.dbal.class_table_name'), 'sid_table_name' => $this->getContainer()->getParameter('security.acl.dbal.sid_table_name'),
				'oid_table_name' => $this->getContainer()->getParameter('security.acl.dbal.oid_table_name'), 'oid_ancestors_table_name' => $this->getContainer()->getParameter('security.acl.dbal.oid_ancestors_table_name'),
