...
class WebProfilerExtensionTest extends TestCase {
	...
	protected function setUp() {
		...
		$this->container->register('templating.engine.twig', $this->getMockClass('Symfony\\Bundle\\TwigBundle\\TwigEngine'))->addArgument(new Definition($this->getMockClass('Twig_Environment')))
	...
	public function getDebugModes() {
		return array(array(true, true), array(true, false), array(false, false), array(false, true),);
	}
